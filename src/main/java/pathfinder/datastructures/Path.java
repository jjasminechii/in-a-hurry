...
/**
 * This represents an immutable path between two cartesian coordinates, particularly
 ...
 *
 * @param <L> this represents the type of the Point
 */
public class Path<L> implements Iterable<Path<L>.Segment> {
     ...
     */
    public Path<L> extend(L newEnd, double segmentCost) {
        checkRep();
        //
        Path<L> extendedPath = new Path<L>(start);
        extendedPath.path.addAll(this.path);
        extendedPath.path.add(new Path<L>.Segment(this.getEnd(), newEnd, segmentCost));
    ...
    public class Segment {
         ...
         */
        private Segment(L start, L end, double cost) {
